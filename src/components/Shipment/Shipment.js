import { Container, Grid, Typography, makeStyles, TextField, withStyles, CircularProgress } from '@material-ui/core';
...
const Shipment = () => {
    ...
    const onSubmit = data => {
        ...
        const orderInfo = { products: savedCart, priceInfo, shipmentInfo: data, orderTime: new Date() }
                            ...
                            <Grid container justify="center">
                                {ordered ?
                                    ...
                                    : <Grid item xs={12} md={6} className={classes.container}>
                                        ...
                                        />
                                        <Controller as={CustomTextField} required multiline rows="3"
                                            error={fields.courierAddress}
                                            helperText={fields.courierAddress ? fields.courierAddress.message : null}
                                            rules={{
                                                minLength: {
                                                    value: 20,
                                            ...
                                            fullWidth type="text" name="courierAddress" control={control} id="outlined-basic" label="Courier Address" variant="outlined" />
